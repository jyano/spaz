...
ssi=loadSSImages=function(a,fn){
    Ql({m:Mf.apply(this,map(a.images,
...
sSpr=function(o){
     o=Do(o);  var x=o.obj,
        ...
        gts="gotoAndStop",
        gtp="gotoAndPlay", av="advance",
        //oae="onAnimationEnd",
        ga="getAnimation",
        gA="getAnimations",
        gfb="getFrameBounds",
        gnf= "getNumFrames",  fr="framerate",
        ca="currentAnimation",
        caf="currentAnimationFrame",
        cf="currentFrame",ae='animationend';
...
Spr = function(ss,b,stg){

    var s="Sprite", sS="SpriteSheet";



    ssi(ss, function(i){
        var spr=new C$[s](new C$[sS](ss))
        if(stg){stg.a(spr)}
        b(sSpr(spr),spr)})}
